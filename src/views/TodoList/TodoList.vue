<template>
 <div class="todo-list">
    ...
    <div v-else class="card-warper">
        <div class="card">
            <p style="font-size: 20px; text-justify: center;">No todos available. Click on Add Todo button to add new todo item</p>
        </div>
    </div>
</div>
</template>
...
export default defineComponent({
    ...
    data: () => ({
        todosGroups: [] as [Priority, { id: string; title: string; priority: Priority; createdAt: string; }[]][],
    }),
